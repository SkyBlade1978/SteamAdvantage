package zone.moddev.mc.steamadvantage;

import zone.moddev.mc.steamadvantage.init.*;
...
@Mod(modid = SteamAdvantage.MODID, version = SteamAdvantage.VERSION, name=SteamAdvantage.NAME, 
		dependencies = "required-after:poweradvantage@[2.4.3.110021,);after:basemetals")
...
{/** The identifier for this mod */
	...
	public static final String VERSION = "2.2.4.110021";
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		for(String e : strs){
			if(e.contains("=")){
				String[] comps = e.split("=", 2);
				String fluidName = comps[0].trim();
				try{
					Float value = Float.parseFloat(comps[1].trim());
					fluidBurnValues.put(fluidName, value);
