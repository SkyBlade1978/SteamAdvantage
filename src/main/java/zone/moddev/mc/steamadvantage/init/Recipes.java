...
public class Recipes {
	...
	public static void init(){
		...
		if(recipeMode == RecipeMode.TECH_PROGRESSION){
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Items.steam_governor,1)," t ","srs","btb",'t',"sprocket",'s',"rod",'r',"rod",'b',"ingotBrass"));
			BaseMetalsCompat.addCrusherRecipe(Items.steam_governor, new ItemStack(zone.moddev.mc.poweradvantage.init.Items.sprocket,2));
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Blocks.steam_track),Blocks.steam_pipe, zone.moddev.mc.poweradvantage.init.Blocks.steel_frame));
